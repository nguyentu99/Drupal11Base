...
(function (Drupal, bootstrap, once) {
  ...
  function getToastContainer() {
    ...
    if (!container) {
      ...
      queue.className = 'visually-hidden';
  ...
  Drupal.behaviors.cassiopeiaAdminToastMessages = {
    attach(context) {
      once('cassiopeia-admin-toast-show', '.toast-container .toast', context).forEach((toastEl) => {
        showToast(toastEl);
      });
    },
  };
